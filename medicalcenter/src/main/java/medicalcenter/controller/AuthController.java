...
import medicalcenter.exception.AppException;
import medicalcenter.model.User;
import medicalcenter.payload.ApiResponse;
import medicalcenter.payload.JwtAuthenticationResponse;
import medicalcenter.payload.LoginRequest;
import medicalcenter.payload.SignUpRequest;
import medicalcenter.security.JwtTokenProvider;
...
public class AuthController {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignUpRequest signUpRequest) throws ParseException {
       ...
       System.out.println(signUpRequest.getBirthdate());
        ...
        //LocalDateTime startTime = LocalDateTime.parse(signUpRequest.getBirthdate(), formatter);
